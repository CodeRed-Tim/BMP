...
//  BMP
//
//  Created by Timmy Van Cauwenberge on 2/4/21.
//
...
//            performSegue(withIdentifier: "secondView", sender: nil) as! SecondViewController
    ...
    @IBAction func didTapSpotifyButton(_ sender: Any) {
